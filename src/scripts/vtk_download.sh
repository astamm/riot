...
if (CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
  set_source_files_properties(vtkBiQuadraticQuadraticWedge.cxx vtkBoundingBox.cxx vtkPath.cxx vtkPentagonalPrism.cxx vtkPolygon.cxx vtkQuadraticLinearWedge.cxx vtkQuadraticTetra.cxx PROPERTIES COMPILE_FLAGS "-Wno-array-parameter")
endif()
